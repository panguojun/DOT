...
namespace math
{
	...
	// 黎曼函数
	inline complex riemann_function(const complex& s, int n = 18)
	{
	...
	void rimann_function_vis()
	{
		for (int i = -100; i < 100; i++)
		{
			...
			{
				math::complex s(0.5 + i / 50.0f, (j - 5000) / 500.0f);
				math::complex fv = riemann_function(s);
		...
		for (int i = -100; i < 100; i++)
		{
			...
			{
				math::complex s(0.5 - i / 10.0f, (j - 5000.0f) / 100.0f);
				math::complex fv = riemann_function(s);
